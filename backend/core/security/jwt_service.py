...
Example usage:
    from backend.core.security.jwt_service import get_current_user, create_access_token
...
from backend.infrastructure.database.database import RevokedToken, AsyncSessionLocal
...
async def verify_token(token: str) -> TokenData:
    ...
    try:
        ...
        if jti:
            from backend.infrastructure.database.database import AsyncSessionLocal, RevokedToken
...
async def authenticate_user(email: str, password: str) -> Optional[Dict[str, Any]]:
    ...
    try:
        from backend.infrastructure.database.database import AsyncSessionLocal, User
        from sqlalchemy import select
        async with AsyncSessionLocal() as db:
