...
class TestHealthEndpoints:
    ...
    @pytest.mark.asyncio
    async def test_health_endpoint_returns_ok(self, test_client: TestClient):
        """
    ...
    @pytest.mark.asyncio
    async def test_health_endpoint_response_format(self, test_client: TestClient):
        """
    ...
    @pytest.mark.asyncio
    async def test_ready_endpoint_returns_ok(self, test_client: TestClient):
        """
        ...
        - Response contains status field
        """
        response = test_client.get("/api/system/ready")
    ...
    @pytest.mark.asyncio
    async def test_ready_endpoint_database_status(self, test_client: TestClient):
        """
...
class TestMetricsEndpoint:
    ...
    @pytest.mark.asyncio
    async def test_metrics_endpoint_returns_data(self, test_client: TestClient):
        """
